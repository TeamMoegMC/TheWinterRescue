onEvent('recipes', (event) => {
    ...
    {output:['2x kubejs:impure_alumina_dust', Item.of('2x kubejs:impure_alumina_dust').withChance(0.5)],input: 'frostedheart:alumina_dust'},
    {output:['kubejs:kaolin_dust', Item.of('kubejs:kaolin_dust').withChance(0.5)],input: 'frostedheart:kaolin'},
