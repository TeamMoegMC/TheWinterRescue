onEvent('recipes', (event) => {
    ...
    {output:['2x frostedheart:bauxite_dust', Item.of('2x frostedheart:bauxite_dust').withChance(0.5)],input: 'frostedheart:crushed_bauxite_ore'},
    {output:['frostedheart:kaolin_dust', Item.of('frostedheart:kaolin_dust').withChance(0.5)],input: 'frostedheart:kaolin'},
    {output:['frostedheart:cryolite_dust', Item.of('frostedheart:cryolite_dust').withChance(0.5)],input: 'frostedheart:crushed_raw_fluorite'},
    {output:['immersiveengineering:dust_sulfur', Item.of('immersiveengineering:dust_sulfur').withChance(0.5)],input: 'frostedheart:sulfur_dust'},
