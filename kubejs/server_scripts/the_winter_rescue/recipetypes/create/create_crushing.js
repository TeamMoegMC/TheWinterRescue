onEvent('recipes', (event) => {
    ...
    {output:[Item.of('kubejs:crushed_ore_halite').withChance(0.25)],input: 'frostedheart:halite_ore'},
	{output:[Item.of('2x frostedheart:sodium_chloride_dust'),Item.of('2x frostedheart:sodium_chloride_dust').withChance(0.5)], input: 'kubejs:washed_ore_halite'}
    ]
