onEvent('recipes', (event) => {
    let items = [
		...
		{output: "6x charcoal_pit:chocolate", input: [Fluid.of('kubejs:protein', 900),"frostedheart:generator_ash"]},
		{output: Fluid.of('minecraft:milk', 2000), input: [Fluid.of('kubejs:protein', 1000),Fluid.of('minecraft:water', 1000),"minecraft:sugar"]},
