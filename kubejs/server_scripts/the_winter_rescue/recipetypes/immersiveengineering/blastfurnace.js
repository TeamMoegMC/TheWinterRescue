onEvent('recipes', (event) => {
    let recipes = [
            ...
            {input: 'rankine:malachite', output: 'rankine:copper_ingot', time: 800},
            {input: 'kubejs:native_copper', output: 'rankine:copper_ingot', time: 800},
            ...
            {input: 'kubejs:silver', output: 'immersiveengineering:ingot_silver', time: 800},
