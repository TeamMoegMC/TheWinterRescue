onEvent('recipes', (event) => {
    let recipes = [
            ...
            // }
            {input1: '#forge:ores/copper', input2: '2x #kubejs:kiln_dust', output: 'rankine:copper_ingot', time: 250},
            {input1: '#forge:ores/tin', input2: '1x #kubejs:kiln_dust', output: 'rankine:tin_ingot', time: 250},
