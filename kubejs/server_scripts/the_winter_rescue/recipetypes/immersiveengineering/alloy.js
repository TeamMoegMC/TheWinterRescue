onEvent('recipes', (event) => {
    let recipes = [
            ...
            // }
            {input1: '#forge:ores/copper', input2: '#kubejs:kiln_dust', output: 'rankine:copper_ingot', time: 300},
            {input1: '#forge:ores/tin', input2: '#kubejs:kiln_dust', output: 'rankine:tin_ingot', time: 300}
        ]
