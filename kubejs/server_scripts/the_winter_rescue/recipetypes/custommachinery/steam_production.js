onEvent('recipes', event => {
    ...
    .produceFluidPerTick(Fluid.of("kubejs:steam", 1), "steamtank")
    .jei();
    ...
    event.recipes.custommachinery.custom_machine("the_winter_rescue:cast_iron_boiler", 200)
        ...
        .produceFluidPerTick(Fluid.of("kubejs:steam", 2), "steamtank")
        .jei();
    ...
    event.recipes.custommachinery.custom_machine("the_winter_rescue:steel_boiler", 200)
        ...
        .produceFluidPerTick(Fluid.of("kubejs:steam", 4), "steamtank")
        .jei();
