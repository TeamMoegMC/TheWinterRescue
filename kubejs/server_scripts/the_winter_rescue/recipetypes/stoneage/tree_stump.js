onEvent('recipes', (event) => {
    const recipes = [
        ...
        tree_stumpRecipe(Item.of('create:iron_sheet'), Item.of('minecraft:iron_ingot'),
            Ingredient.of('#forge:hammers'), 3, 2),
        tree_stumpRecipe(Item.of('kubejs:cast_iron_plate'), Item.of('frostedheart:cast_iron_ingot'),
            Ingredient.of('#forge:hammers'), 3, 2),
        tree_stumpRecipe(Item.of('immersiveengineering:plate_gold'), Item.of('minecraft:gold_ingot'),
            Ingredient.of('#forge:hammers'), 3, 2),
        tree_stumpRecipe(Item.of('kubejs:invar_steel_plate'), Item.of('frostedheart:invar_ingot'),
            Ingredient.of('#forge:hammers'), 3, 2),
        ...
        tree_stumpRecipe(Item.of('frostedheart:alumina_dust'), Item.of('frostedheart:bauxite'),
            Ingredient.of('#forge:hammers'), 3),
