onEvent('recipes', (event) => {
    const recipes = [
    campfireRecipe(Item.of('watersource:wooden_cup_drink', '{Fluid:{FluidName:"watersource:purified_water",Amount:250}}'), Item.of('watersource:wooden_cup_drink', '{Fluid:{FluidName:"minecraft:water",Amount:250}}'),300),
    campfireRecipe(Item.of('watersource:wooden_cup_drink', '{Fluid:{FluidName:"frostedheart:hot_water",Amount:250}}'), Item.of('watersource:wooden_cup_drink', '{Fluid:{FluidName:"watersource:purified_water",Amount:250}}'),100),
	...
	campfireRecipe('watersource:purified_water_bottle', Item.of('minecraft:potion', '{Potion:"minecraft:water"}'),300),
