...
ServerEvents.recipes((event) => {
	...
	let ores = ["frostedheart:raw_pyrite", "frostedheart:raw_nickel", "frostedheart:raw_tin", "frostedheart:bauxite", "frostedheart:kaolin", "frostedheart:raw_magnesite", "frostedheart:raw_lead", "frostedheart:raw_halite", "frostedheart:raw_silver", "minecraft:raw_gold", "minecraft:raw_iron", "create:raw_zinc", "minecraft:raw_copper"]
	let ore_name = ["pyrite", "nickel", "tin", "bauxite", "kaolin", "magnesite", "lead", "halite", "silver", "gold", "iron", "zinc", "copper"]
	let by_products = [];
	let i;
	let ores_i;
	let ore_name_i;
	...
	*/
	...
	let data = {
		recipes: [
			...
			{ output: "immersiveengineering:ingot_nickel", input: "frostedheart:crushed_raw_nickel", time: 300 },
	...
	*/
	...
	let blastFurnaceRecipes = [
		...
		["immersiveengineering:ingot_nickel", "frostedheart:crushed_raw_nickel", 300],
