...
by_products[3] = [Item.of("frostedheart:cryolite_dust").withChance(0.2)];
    ...
    event.smelting('immersiveengineering:ingot_lead', 'frostedheart:crushed_raw_galena');
    event.smelting('frostedheart:tin_ingot', 'frostedheart:crushed_raw_cassiterite');
    var data = {
        recipes: [
