...
onEvent("ponder.registry", event => {
	...
	event.create("the_winter_rescue:charcoal_pit", ["charcoal_pit:log_pile"])
        ...
        .scene("basic_usage", "", "kubejs:charcoal_pit", (scene, util) => {
			...
			scene.world().setBlock(util.grid().at(2, 2, 2), util.getDefaultState("minecraft:fire"), true)
            scene.world().setBlock(util.grid().at(1, 2, 2), util.getDefaultState("minecraft:fire"), true)
            scene.world().setBlock(util.grid().at(3, 2, 2), util.getDefaultState("minecraft:fire"), true)
            scene.world().setBlock(util.grid().at(2, 2, 1), util.getDefaultState("minecraft:fire"), true)
            scene.world().setBlock(util.grid().at(1, 2, 1), util.getDefaultState("minecraft:fire"), true)
            scene.world().setBlock(util.grid().at(3, 2, 1), util.getDefaultState("minecraft:fire"), true)
            scene.world().setBlock(util.grid().at(2, 2, 3), util.getDefaultState("minecraft:fire"), true)
            scene.world().setBlock(util.grid().at(1, 2, 3), util.getDefaultState("minecraft:fire"), true)
            scene.world().setBlock(util.grid().at(3, 2, 3), util.getDefaultState("minecraft:fire"), true)
			scene.world().modifyBlock(util.grid().at(2, 1, 2), state => state.with("lit", true))
            ...
            scene.world().setBlock(util.grid().at(2, 2, 2), util.getDefaultState("minecraft:air"), true)
            scene.world().setBlock(util.grid().at(1, 2, 2), util.getDefaultState("minecraft:air"), true)
            scene.world().setBlock(util.grid().at(3, 2, 2), util.getDefaultState("minecraft:air"), true)
            scene.world().setBlock(util.grid().at(2, 2, 1), util.getDefaultState("minecraft:air"), true)
            scene.world().setBlock(util.grid().at(1, 2, 1), util.getDefaultState("minecraft:air"), true)
            scene.world().setBlock(util.grid().at(3, 2, 1), util.getDefaultState("minecraft:air"), true)
            scene.world().setBlock(util.grid().at(2, 2, 3), util.getDefaultState("minecraft:air"), true)
            scene.world().setBlock(util.grid().at(1, 2, 3), util.getDefaultState("minecraft:air"), true)
            scene.world().setBlock(util.grid().at(3, 2, 3), util.getDefaultState("minecraft:air"), true)
