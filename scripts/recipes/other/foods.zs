...
for i in 0 .. logs.length{
	<recipetype:stone_age:millstone>.addRecipe(logs[i].commandString + "sawdust", <item:immersiveengineering:dust_wood>, <item:immersiveengineering:dust_wood>,logs[i],0.5, 2); 
}
